    ...
    <div class="container">
        <div class="row mt centered">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <h3>The main purpose of this portal is to help someone manage how they consume their Electricity and how they pay for it.</h3>
            </div>
        </div>
        <!-- /row -->
        ...
        <div class="row mt centered">
            <div class="col-lg-4">
                ...
                <h4>1 - Login</h4>
                <p>Kindly enter your details in order to Login!</p>
            </div>
            <!--/col-lg-4 -->
            ...
            <div class="col-lg-4">
                ...
                <h4>2 -  Bills</h4>
                <p>Billing Section of this system.</p>
            ...
            <div class="col-lg-4">
                ...
                <h4>3 - Transact</h4>
                <p>Transaction side of this system.</p>
